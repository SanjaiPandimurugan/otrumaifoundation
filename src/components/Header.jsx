...
const Header = () => {
  ...
  return (
    <header className="fixed w-full top-4 z-50 px-4">
      <div className="max-w-5xl mx-auto bg-white rounded-full py-2 px-5 shadow-lg nav-white">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <div className="flex items-center">
            <img src={logo} alt="Otrumai Foundation" className="h-8" />
            <span className="ml-2 text-base font-semibold text-gray-800">Otrumai Foundation</span>
          </div>
      ...
      {isMenuOpen && (
        <nav className="md:hidden mt-2 py-3 px-4 bg-white rounded-lg shadow-lg max-w-5xl mx-auto nav-white">
          <div className="flex flex-col space-y-3">
            ...
            <a href="#about" className="text-primary-600 font-medium">About Us</a>
            <a href="#projects" className="text-primary-600 font-medium">Our Projects</a>
            <a href="#gallery" className="text-primary-600 font-medium">Gallery</a>
            <a 
              href="#donate" 
              className="bg-gradient-to-r from-primary-500 to-secondary-500 text-white px-4 py-2 rounded-full font-medium text-center"
            >
              Donate
            </a>
          </div>
